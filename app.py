...
class App(QWidget):
    ...
    def patchPathOpen(self):
        ...
        self.qPlainTextEdit.setTextCursor(self.cursor)
        QApplication.processEvents()
        #self.patchFolderPath = self.patchFolderPath +"/firmware-"+ str(self.baseFirmware) + "to" + str(self.newFirmware) + ".bin"
        self.patchFileName = str(self.baseFirmware) + "_to_" + str(self.newFirmware) + ".bin"
